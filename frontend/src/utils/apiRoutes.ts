...
export const MovieRoutes = {
  ...
  VIDEO: (movieID: string) => `${BASE_URL}/movies/${movieID}/video`,
...
export const SeriesRoutes = {
  ...
  VIDEO: (seriesID: string) => `${BASE_URL}/series/${seriesID}/video`,
...
export const EpisodeRoutes = {
  ...
  VIDEO: (episodeID: string) => `${BASE_URL}/episodes/${episodeID}/video`,
